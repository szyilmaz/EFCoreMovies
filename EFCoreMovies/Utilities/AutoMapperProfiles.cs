...
namespace EFCoreMovies.Utilities
{
    public class AutoMapperProfiles : Profile
    {
        ...
        {
            GeometryFactory _geometryFactory = NtsGeometryServices.Instance.CreateGeometryFactory(srid: 4326);
            ...
            CreateMap<CinemaCreationDTO, Cinema>()
                    .ForMember(ent => 
                    ent.Location, 
                    dto => dto.MapFrom(prop => _geometryFactory.CreatePoint(new Coordinate(prop.Longitude, prop.Latitude))));
